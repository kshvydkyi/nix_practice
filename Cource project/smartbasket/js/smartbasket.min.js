    ...
    t = jQuery, a = {
        ...
        showProducts: function(s) {
            let r = t("<form>").attr({
                ...
                }).html("Ціна за 1 товар чи послугу").append(p),
                u = t("<div>").attr({
                    class: "smart-basket__product-price"
                }).html(`Ціна / ${a.smartBasketCurrency}`).append(c).append(d);
            c.click(() => {
                d.fadeToggle()
            }), p.click(t => {
                t.preventDefault(),
            ...
            let m = t("<div>").attr({
                ...
                }).html(`Загальна ціна / ${a.smartBasketCurrency}`),
                k = t("<div>").attr({
                    class: "smart-basket__product-delete"
                }).text("Видалити");
            ...
            for (let n in s) {
                ...
                for (let a in s[n]) {
                    ...
                    if ("sbName" === a && (c.append(`<span>${s[n][a]}</span>`), p.val(s[n][a])), "sbSize" === a && void 0 !== s[n][a] && (c.children("span").append(`<span class="smart-basket__product-size"> Розмір: ${s[n][a]}</span>`), d.val(s[n][a])), "sbPrice" === a && (_.html(s[n][a]), h.val(s[n][a])), "sbPriceCommon" === a) {
                        let t = +s[n][a];
                        y.val(+t.toFixed(2))
                    }
        ...
        stateBasket: function() {
            ...
            return e.getSmartBasketMinState(o), c.click(function() {
                ...
                if (void 0 !== r[n]) {
                    let a = t(this).html();
                    return t(this).text("Товар вже у кошику"), t("body").append(e.alertBlock("alreadyAdded")), setTimeout(() => {
                        t(this).html(a)
                    }, 1500), !1
                } {
                    let i = {};
        ...
        commonResult: function(e, s, r) {
            let n = 0,
                ...
                }).text("Кошик пустий. Ви не додали жодного товару").fadeOut(),
                l = t("<div>").attr({
                    class: "smart-basket__success-title"
                }).text("Замовлення прийняте. Чекайте на дзвінок").css("display", "none"),
                c = t("<div>").attr({
            ...
            if (0 == +n ? o.fadeIn() : o.fadeOut(), r) t("." + l.attr("class")).css("display", "block"), setTimeout(() => {
                ...
                if (!s) return d.html(`<span>Всього товарів: </span> ${n}`), p.html(`<span>Загальна вартість: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(2)} ${a.smartBasketCurrency}">`), c.append(o).append(l).append(d).append(p), c;
                0 == +n && t("." + o.attr("class")).css("display", "block"), t("." + d.attr("class")).html("<span>Всього товарів: </span> "), t("." + d.attr("class")).html(`<span>Всього товарів: </span> ${n}`), t("." + p.attr("class")).html("<span>Загальна вартість: </span> "), t("." + p.attr("class")).html(`<span>Загальна вартість: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(2)} ${a.smartBasketCurrency}">`)
            }
        },
        getSmartBasketMinState: function(s, r) {
            ...
            r ? (t("." + l.attr("class")).html(""), t("." + l.attr("class")).html(`<svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg> Кошик ${n}`)) : (l.html(`<svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M5.08127 0.555126L3.2142 3.66666H7.7858L5.918 0.555126L6.54867 0.178192L8.64087 3.66666H10.4845C10.769 3.66666 11 3.89766 11 4.18219V4.50413C11 6.66288 10.4974 8.79198 9.53187 10.7228C9.49018 10.8061 9.42612 10.8762 9.34685 10.9252C9.26758 10.9741 9.17624 11 9.08307 11H1.91693C1.8237 10.9999 1.73234 10.9738 1.65308 10.9247C1.57382 10.8756 1.50978 10.8055 1.46813 10.7221C0.502632 8.79125 -1.72126e-05 6.66215 4.42075e-10 4.50339L4.42076e-10 4.18219C4.42076e-10 3.89766 0.231 3.66666 0.515533 3.66666H2.35913L4.45133 0.178192L5.08053 0.555126H5.08127Z" fill="#976464"/>
        </svg> Кошик ${n}`), t("." + a.smartBasketMinArea).append(i.append(o).append(l))), e.getModalBasket(i, s)
        },
            ...
            if (c.append(p), a.agreement.isRequired) {
                ...
                let e = t("<label>").attr({
                    ...
                    s = t("<input>").attr({
                        ...
                        value: "Я приймаю умови користувальницької угоди"
                    }),
                    r = null;
                r = a.agreement.isLink ? t("<a>").attr({
                    ...
                    class: "smart-basket__link-agreement"
                }), s.is(":checked") ? r.text("Я приймаю умови користувальницької угоди") : r.text("Я не приймаю умови користувальницької угоди"), e.click(function() {
                    s.is(":checked") ? (r.text("Я не приймаю умови користувальницької угоди"), s.val("Я не приймаю умови користувальницької угоди"), m.attr({
                        disabled: "disabled"
                    }), d.addClass("smart-basket__input-wrapper_error")) : (r.text("Я приймаю умови користувальницької угоди"), s.val("Я приймаю умови користувальницької угоди"), m.attr({
                        disabled: !1
        ...
        return e[a] ? e[a].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof a && a ? void t.error("Метод " + a + " не знайдений") : e.init.apply(this, arguments)
    }
});
